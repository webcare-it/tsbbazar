...
class DivisionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::select(DB::raw("
            INSERT INTO `sub_districts` (`id`, `district_id`, `name`, `bn_name`) VALUES
            ...
            (493, 1, 'Uttara', 'উত্তারা'),
            (494, 1, 'Banani', 'বনানী'),
            (495, 1, 'Gulshan', 'গুলশান'),
            (496, 1, 'Mohakhali', 'মহাখালী'),
            (497, 1, 'Farmgate', 'ফার্মগেট'),
            (498, 1, 'Bongshal', 'বংশাল'),
            (499, 1, 'Old Dhaka', 'পুরান ঢাকা'),
            (500, 1, 'Motijheel', 'মতিঝিল'),
            (501, 1, 'Polton', 'পল্টন'),
            (502, 1, 'Komlapur', 'কমলাপুর'),
            (503, 1, 'Arambag', 'আরামবাগ'),
            (504, 1, 'Malibag', 'মালিবাগ'),
            (505, 1, 'Sahbag', 'শাহবাগ'),
            (506, 1, 'Dhaka University', 'ঢাবি'),
            (507, 1, 'Elephant Road', 'এলিফেন্ট রোড'),
            (508, 1, 'Dhanmondi', 'ধান্মন্ডি'),
            (509, 1, 'Mohammadpur', 'মোহাম্মাদপুর'),
            (510, 1, 'Shyamoli', 'শ্যামলী'),
            (511, 1, 'Mirpur', 'মিরপুর'),
            (512, 1, 'Badda', 'বাড্ডা'),
            (513, 1, 'Boshundhara', 'বসুন্ধরা'),
            (514, 1, 'Khilkhet', 'খিলখেত'),
            (515, 1, 'Airport', 'এয়ারপর্ট')
        "));
    }
}
