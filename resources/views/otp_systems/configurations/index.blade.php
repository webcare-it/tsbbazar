...
@section('content')
    ...
    <div class="row">
        ...
        <!-- Add BulkSMSBD configuration -->
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('BulkSMSBD Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="BULKSMSBD_API_KEY" value="{{  env('BULKSMSBD_API_KEY') }}" placeholder="API KEY" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="BULKSMSBD_SENDER_ID" value="{{  env('BULKSMSBD_SENDER_ID') }}" placeholder="SENDER ID" required>
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
