                ...
                <div class="col">
                    <div class="card radius-10 mb-0">
                        <div class="card-header bg-gradient-burning">
                            <h5 class="mb-1 text-white">Customer Review create</h5>
                            <a href="{{ url('/admin/customer/review') }}" class="btn btn-sm btn-primary float-end" style="margin-top: -25px;">Review List</a>
                        </div>
                        <div class="card-body">
                            <form action="{{ url('/admin/customer/review/store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label>Rating*</label>
                                    <input type="number" name="rating" class="form-control" placeholder="Customer rating">
                                    <span style="color: red"> {{ $errors->has('rating') ? $errors->first('rating') : ' ' }}</span>
                                </div>
                                <div class="form-group">
                                    <label>Phone</label>
                                    <input type="tel" name="phone" class="form-control" placeholder="Customer name">
