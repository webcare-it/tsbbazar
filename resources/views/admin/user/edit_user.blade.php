                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" value="{{$user->name}}" class="form-control" placeholder="User name" required><br>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label style="padding-bottom: 5px;font-weight: 600;font-size: 15px;letter-spacing: 1px;">Name <small style="color: red; font-size: 18px;">*</small></label>
                                                    <input type="number" name="order_limit" value="{{$user->order_limit}}" class="form-control" placeholder="User order limit" required><br>
                                                    <span style="color: red"> {{ $errors->has('order_limit') ? $errors->first('order_limit') : ' ' }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" value="{{$user->email}}" class="form-control" placeholder="User email" required><br>
                                                    <span style="color: red"> {{ $errors->has('email') ? $errors->first('email') : ' ' }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label style="padding-bottom: 5px;font-weight: 600;font-size: 15px;letter-spacing: 1px;">New Password <small style="color: red; font-size: 18px;">*</small></label>
                                                    <input type="text" name="password" value="{{ old('password') }}" class="form-control" placeholder="User password"><br>
