    				...
    				<div class="aiz-file-box">
    					<div class="dropdown-file" >
    						...
    						<div class="dropdown-menu dropdown-menu-right">
    							...
    							<a href="javascript:void(0)" class="dropdown-item confirm-alert" data-href="{{ route('uploaded-files.destroy', ['id' => $file->id] ) }}" data-target="#delete-modal">
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <form method="POST" action="" class="d-inline-block confirm-form" id="delete-form">
                    @method('DELETE')
                    @csrf
...
@section('script')
	<script type="text/javascript">
        ...
        // Handle delete confirmation - set the correct form action
