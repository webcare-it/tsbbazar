                    ...
                    @foreach($products as $key => $product)
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <button type="button" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('digitalproducts.destroy', ['digitalproduct'=>$product->id])}}" title="{{ translate('Delete') }}">
