                    ...
                    <tr>
                     ...
                     {{-- @if($type == 'Seller' || $type == 'All')
                        ...
                        <td class="text-right">
                            ...
                            <button type="button" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('admin.products.destroy', ['product'=>$product->id])}}" title="{{ translate('Delete') }}">
