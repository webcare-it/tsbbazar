        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left">
                    <h1 class="fw-600 h4">{{ translate('Edit Product') }}</h1>
                </div>
                <div class="col-lg-6">
                    <ul class="breadcrumb bg-transparent p-0 justify-content-center justify-content-lg-end">
                        ...
                        <li class="breadcrumb-item opacity-50">
                            <a class="text-reset" href="{{ route('dashboard') }}">{{ translate('Dashboard')}}</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a class="text-reset" href="{{ route('customer_products.index') }}">{{ translate('All Products')}}</a>
                        </li>
                        <li class="breadcrumb-item fw-600">
                            <a class="text-reset" href="{{ route('customer_products.edit', $product->id) }}">{{ translate('Edit Product')}}</a>
                        </li>
                    </ul>
                </div>
            </div>
